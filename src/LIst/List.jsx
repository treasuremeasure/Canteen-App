    ...
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-1 gap-3 p-4">
        ...
        <div className="flex h-full flex-col gap-4 rounded-xl bg-white shadow-md min-w-40">
         ...
         {/* Сэндвич "Тюна" */}
         <div className="flex h-full flex-col gap-4 rounded-xl bg-white shadow-md min-w-40">
            <div className="w-full bg-center bg-no-repeat aspect-square bg-cover rounded-xl bg-[url('https://cdn.usegalileo.ai/sdxl10/032aac91-2c80-4374-ab1b-232dab963a6a.png')]"></div>
            <div className="flex flex-col flex-1 justify-between p-4 pt-0 gap-4">
              <div>
                <p className="text-[#181411] text-base font-medium leading-normal">Сэндвич "Тюна"</p>
                <p className="text-[#897361] text-sm font-normal leading-normal">450 руб</p>
              </div>
              <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-[#f4f2f0] text-[#181411] text-sm font-bold leading-normal tracking-[0.015em]">
                <span className="truncate">Выбрать</span>
              </button>
