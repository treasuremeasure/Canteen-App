            ...
            <div>
                ...
                <div className="flex px-4 py-3">
                    <button onClick={returnToMenu}
                        className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-5 flex-1 bg-[#ee7f2b] text-[#FFFFFF] text-base font-bold leading-normal tracking-[0.015em]"
                    >
                        <span className="truncate text-black">Вернуться в меню</span>
                    </button>
                </div>
            </div>
        </>
